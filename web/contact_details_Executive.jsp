...
<html>
    <head>
        ...
        <script type="text/javascript">
            ...
            function updateContact(){
                ...
                form1.action="Controller?process=ExecutiveProcess&action=updateContactDetails&id=<c:out value='${executiveDetails.eid}'/>";
                form1.submit();
            }
    ...
    <body background="images/bg.jpg">
        ...
        <form  method="post" id="form1">
            ...
            <table width="100%">
                <tr>
                    <td  class="headerTD">NAME: &nbsp;<c:out value="${executiveDetails.name}" />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Total number of subscribers made: &nbsp;<c:out value="${subscribersByExecutive}" />
                    ...
                    <table  border="0px" width="100%"  id="table1" align="center">
                        ...
                        <tr>
                            ...
                            <td width="25%" class="tablerows" >
                                <c:out default="" value="${executiveDetails.name}" />
                            </td>
                            <td width="25%"  class="alignLeft" height="50" >Contact Number
                            </td>
                            <td width="25%" class="tablerows" >
                                <c:out default="" value="${executiveDetails.contactnumber}" />
                            </td>
                        </tr>
                        <tr>
                            <td width="25%"   class="alignLeft" height="50" >Email</td>
                            <td width="25%" class="tablerows"  >
                                <c:out default="" value="${executiveDetails.email}" />
                            </td>
                            <td  width="25%"  class="alignLeft" height="50">Address
                            </td>
                            <td width="25%" class="tablerows">
                                <c:out default="" value="${executiveDetails.address}" />
                            </td>


                        </tr>
                        <tr>
                            <td width="25%"  class="alignLeft" height="50">Joining Date</td>
                            <td width="25%" class="tablerows" >
                                <c:out value="${executiveDetails.joiningdate}" />
                            </td>
                            <td width="25%"  class="alignLeft" height="50" >Remarks
                            </td>
                            <td width="25%"  class="tablerows">
                                <c:out default="" value="${executiveDetails.remarks}" />
                            </td>
                        </tr>
