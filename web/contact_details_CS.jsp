    ...
    <head>
        ...
        <script type="text/javascript">
            ...
            function updateContact(){
                ...
                form1.action="Controller?process=PersonalProcess&action=updateContactDetailsCS&id=<c:out value='${personal.pid}'/>";
                form1.submit();
            }
        ...
        <form  method="post" id="form1">
            ...
            <table width="100%">
                <tr>
                    ...
                    <td> <input type="hidden" name="subscriber" value="${personal.subscriber}" id="subscriber"  /></td>  
