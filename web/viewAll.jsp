    ...
    <body  >
        ...
        <form name="form1" id="form1"action="Controller?process=PersonalProcess&action=archiveMultiple" method="post">
            <div style="overflow: hidden">
                <table width="100%">
                    <tr>
                        <td  class="headerTD">View All Subscribers<input type="hidden" name="hiddenChest" value="subscriber" id="hiddenChest"/></td>
                    </tr>
                    ...
                    <tr>
                        ...
                        <td align="right">
                            ...
                            <input type="text" id="advsearch" name="advsearch" onblur=""  />
                            <!--<input type="text" id="advsearch" name="advsearch" onblur="refreshPage();"  /> -->
                            <input type="button" id="go" name="go" value="Go"  onclick="redirect();getlist();">
                        </td>
                    </tr>
                ...
                <table   width="100%"  border="0" style="border-color:#4b6a84;"  id="myTable">
                    ...
                    <thead>
                        <tr  >
                            ...
                            <th title="click to sort" class="headerText">District&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</th>
                            <th title="click to sort" class="headerText">Remaining Issues</th>
                    ...
                    <tbody>
                        <c:forEach items="${PersonalDetailsList}" var="Personal">
                            ...
                            <tr class="trClass" style="border-color:#000000" border="1"  cellpadding="1"  cellspacing="1" >
                                ...
                                <td  class="dataText"><c:out value="${Personal.dist}"/></td>
