...
-->
    ...
    <body background="images/bg.jpg" >
        <form id="form1" action="Controller?process=PersonalProcess&action=distList"  method="post">
    <table height="462" class="tableCSS"  >
      <tr>
        ...
        <p class="style1">
            ...
            <input type="submit" value="Add New" id="addnew" onClick="JavaScript:window.location='addContact.jsp';">
        </p></td>
      </tr>
    </table>
            </form>
