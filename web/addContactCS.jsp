...
<html>
    ...
    <body ><form id="form1"  method="post"  >
            ...
            <div >
                <div id="tabs">
                    <ul>
                        <li><a href="#tabs-1">Complementary subscriber's Contact Details</a></li>
                    ...
                    <div id="tabs-1">
                        <table width="100%" border="0" align="center"  id="table1">
                            ...
                            <tr>
                                <td>
                                    <label>
                                        <input name="complsubscriber" type="hidden" value="1" class="textField" id="complsubscriber" size="36"  >
                                    </label>
                                    <br/>
                                </td>
                            </tr>
                            ...
                            <tr>
                                ...
                                <td width="12%" align="left">
                                    <label>
                                        <input name="name" type="text" class="textField" id="name" size="36" onblur="validateName(); "  onkeyup="check(this.value);">
                                    </label>
                                </td>
                                ...
                                <td>
                                    <label>
                                        <input name="contactNO" type="text" class="textField" id="contactNO" size="36" onblur="validateContact();checkmobile(this.value);" onkeypress="return validateContactNum(this);" >
                                    </label>
                            ...
                            <tr>
                              ...
                              <!--  <td width="16%"  class="alignRight" >City &nbsp;  </td>
                                ...
                                <td>
                                    ...
                                    <label>
                                        <input name="addcity" type="text" style="display: none;" class="textField" id="addcity" size="36"  >
                                    </label>
                                </td> -->
                                ...
                                <td width="28%"  >
                                    ...
                                    <label>
                                        <input name="adddist" type="text" style="display: none;" class="textField" id="adddist" size="36"  >
                                    </label>
                                </td>
                                ...
                                <td width="28%"  >
                                    <label>
                                        <input name="pincode" type="text" class="textField" id="pincode" size="36" onblur="validateContact();validateNameContact();" onkeypress="return validateContactNum(this);" >
                            ...
                            <!--<tr>
                                ...
                                <td>
                                    <label>
                                        <input name="landmark" type="text" class="textField" id="landmark" size="36" onclick="validateNameContact();" >
                          ...
                          <!--  <tr>
                                ...
                                <td width="20%" class="alignRight" >No. Of Issues &nbsp;
                                </td>
                                <td width="28%"  >
                                    <label>
                                        <input name="noofissues" type="text" class="textField" id="noofissues" size="36" onblur="validateContact();noofissues();" onkeypress="return validateContactNum(this);" >
        ...
        <script type="text/javascript">
            ...
            function addContact(){
                ...
                form1.action="Controller?process=PersonalProcess&action=complementarysubscription";
                form1.submit();
            }
