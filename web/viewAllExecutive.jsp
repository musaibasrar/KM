...
<html >
    ...
    <body  >
        ...
        <form name="form1" id="form1"action="Controller?process=ExecutiveProcess&action=deleteExecutiveMultiple" method="post">
            <div style="overflow: hidden">
                <table width="100%">
                    <tr>
                        <td  class="headerTD">View All Executives</td>
                    </tr>
                ...
                <table   width="100%"  border="0" style="border-color:#4b6a84;"  id="myTable">
                    ...
                    <thead>
                        <tr  >
                            ...
                            <th title="click to sort" class="headerText">E-Mail&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</th>
                    ...
                    <tbody>
                        <c:forEach items="${ExecutiveListAll}" var="Executive">

                            <tr class="trClass" style="border-color:#000000" border="1"  cellpadding="1"  cellspacing="1" >
                                <td class="dataText"><input type="checkbox" id = "<c:out value="${Executive.eid}"/>" class = "chcktbl"  name="executiveIDs"  value="<c:out value="${Executive.eid}"/>"/></td>
                                <td  class="dataTextInActive"><a class="dataTextInActive" href="Controller?process=ExecutiveProcess&action=viewDetails&id=<c:out value='${Executive.eid}'/>"><c:out value="${Executive.name}"/></a></td>
                                <td class="dataText"><c:out value="${Executive.contactnumber}"/></td>
                                <td  class="dataText"><c:out value="${Executive.email}"/></td>
