...
function issues(){
    ...
    <body onload="reformatDate();" >
        <form action="Controller?process=PersonalProcess&action=viewAllComplementary" id="form1"    method="POST">
            <div >
                <div id="tabs">
                    <ul>
                    ...
                    <div id="tabs-1">
                        <table width="70%" border="0" align="center"  id="table1">
                            ...
                            <tr>
                                ...
                                <td align="left">
                                    <label>
                                        ...
                                        <input name="email" type="text" class="textField" value="<c:out default="" value="${personal.email}" />" id="email" size="30"  >
                            ...
                            <!--<tr>
                                <td width="20%"  class="alignRight" >City &nbsp;</td>

                                <td width="20%" align="left">
                                    <label>

                                        <input name="city" type="text" class="textField" value="<c:out default="" value="${personal.city}" />"  id="city" size="30" data-validate="validate(required)" >
                            ...
                            <tr>
                                ...
                                <td width="16%"  class="alignRight" >No. Of Issues&nbsp;  </td>
                            ...
                            <tr>
                                <td width="16%"  class="alignRight" >From issue no. &nbsp;  </td>
                                ...
                                <td width="16%"  class="alignRight" >To Issues no. &nbsp;  </td>
                                </td>
                                <td width="25%" class="tablerows" >
                                    <label>
                            ...
                            <tr>
                                ...
                                <td align="left">
                                    <label>
                                        ...
                                        <input name="noOfChildren" type="hidden"  class="textField" id="noOfChildren" size="30" data-validate="validate(required)" >
                                ...
                                <td align="left">
                                    <label>
                                        ...
                                        <input name="remarks" type="hidden"  class="textField"  id="remarks" size="30" data-validate="validate(required)" >
                        ...
                        <table id="table2" width="30%" border="0" align="center">
                            ...
                            <tr>
                                ...
                                <td>&nbsp;&nbsp;&nbsp;&nbsp;<button  id="subscribe">Subscribe</button></td>
        ...
        <script type="text/javascript">
            ...
            function subscribe(){
                ...
                var form1=document.getElementById("form1");
                form1.action="Controller?process=PersonalProcess&action=subscribe";
                form1.submit();
            }
