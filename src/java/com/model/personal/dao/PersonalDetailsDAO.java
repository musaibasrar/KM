...
public class PersonalDetailsDAO {
    ...
    public List<PersonalDetails> readListOfObjectsfromcomplementary() {
        ...
        try {
            ...
            results = (List<PersonalDetails>) session.createQuery("From PersonalDetails p where p.complementarysubscription=1 and p.archive = 0 order by name").list();
    ...
    public void archiveMultiple(List<Long> ids) {
        try {
            transaction = session.beginTransaction();
    ...
    public List<PersonalDetails> readListOfObjectsForPrintCS() {
        ...
        try {
            ...
            // results = (List<PersonalDetails>) session.createQuery("From PersonalDetails p where  p.archive = 0 order by name").list();
            Query query = session.createQuery("From PersonalDetails  p where p.complementarysubscription=1 and  p.archive = 0  order by name");
            query.setFirstResult(0);
            query.setMaxResults(500);
            results = query.list();
            transaction.commit();
    ...
    public List<PersonalDetails> readListOfObjectsForConfirmPrint(int offset, int noOfRecords) {
        List<PersonalDetails> results = new ArrayList<PersonalDetails>();
        ...
        try {
            ...
            Query query = session.createQuery("From PersonalDetails p where p.archive = 0 and p.noofissues >= 1 order by name ");
            query.setFirstResult(offset);
            query.setMaxResults(noOfRecords);
            results = query.list();
            transaction.commit();
    ...
    public int getNoOfRecordsOfComplSubscribers() {
        ...
        try {
            ...
            results = (List<PersonalDetails>) session.createQuery("From PersonalDetails p where p.complementarysubscription=1 ").list();
            noOfRecords = results.size();
            System.out.println("The size of list is:::::::::::::::::::::::::::::::::::::::::: " + noOfRecords);
            transaction.commit();
    ...
    public List<PersonalDetails> readListOfObjectsForBetweenDates(String fromDate, String toDate) {
        ...
        try {
            ...
            Query sqlQuery = session.createSQLQuery("SELECT * FROM personal_details where subscriber=1 and  archive = 0 and noofissues > 0 and str_to_date(createddate,'%m/%d/%Y')  between '" + fromDateFormatted + "' and '" + toDateFormatted + "' ").addEntity(PersonalDetails.class);
    ...
    public List<PersonalDetails> readListOfObjectsPaginationForSearchForComplS(String criteria) {
        ...
        try {
            ...
            Query query = session.createQuery("From PersonalDetails  p where  p.complementarysubscription=1 and  p.archive = 0  and p.dist='" + criteria + "' order by pincode");
            ...
            if (resultSize == 0) {
                ...
                Query queryState = session.createQuery("From PersonalDetails  p where  p.complementarysubscription=1 and  p.archive = 0  and p.subscribedby='" + criteria + "' order by pincode");
    ...
    public List<PersonalDetails> readListOfObjectsForBetweenDatesComplS(String fromDate, String toDate) {
        ...
        try {
            ...
            //Original Query query = session.createQuery("From PersonalDetails  p where p.complementarysubscription=1 and  p.archive = 0 and p.createddate between '" +fromDate+ "' and '"+toDate+"' order by pincode");
            String myArray[] = fromDate.split("/");
            String myArray2[] = toDate.split("/");
            String fromDateFormatted = myArray[2] + "/" + myArray[0] + "/" + myArray[1];
            String toDateFormatted = myArray2[2] + "/" + myArray2[0] + "/" + myArray2[1];
            ...
            Query sqlQuery = session.createSQLQuery("SELECT * FROM personal_details where complementarysubscription=1 and  archive = 0  and str_to_date(createddate,'%m/%d/%Y')  between '" + fromDateFormatted + "' and '" + toDateFormatted + "' ").addEntity(PersonalDetails.class);
            results = sqlQuery.list();
    ...
    public List<PersonalDetails> readListOfObjectsPaginationForSearchForComplSState(String criteria) {
        ...
        try {
            ...
            Query queryState = session.createQuery("From PersonalDetails  p where  p.complementarysubscription=1 and  p.archive = 0  and p.state='" + criteria + "' order by pincode");
    ...
    public List<PersonalDetails> readListOfObjectsForBetweenDatesCreditS(String fromDate, String toDate) {
        ...
        try {
            ...
            //Query sqlQuery = session.createSQLQuery("SELECT * FROM personal_details where str_to_date(createddate,'%m/%d/%Y')  between '" +fromDateFormatted+ "' and '"+toDateFormatted+"'");
            Query sqlQuery = session.createSQLQuery("SELECT * FROM personal_details where creditsubscribers=1 and  archive = 0 and noofissues > 0 and str_to_date(createddate,'%m/%d/%Y')  between '" + fromDateFormatted + "' and '" + toDateFormatted + "' ").addEntity(PersonalDetails.class);
            results = sqlQuery.list();
            // System.out.println("The SQL Query with str to date is "+results.size());
